...
> **⚠️ 注意**: 本文档原本基于gewechat通道编写。gewechat通道已不再可用,请改用wework或其他可用通道。用户信息对接功能在其他通道上也可使用。

## 1. 简介

新增用户信息对接dify的能力,会把用户id、用户名称、群聊id、群聊名称信息传递给dify,
...
```bash
{
  ...
  "channel_type": "wework",                     # 通道类型设置为wework(或其他可用通道)
